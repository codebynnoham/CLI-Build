...
public record Car(String registrationNumber, String brand, String model, int yearOfManufacture, Category carCategory,
                  EngineType engineType) {
    public Car(String registrationNumber, String brand, String model, int yearOfManufacture, Category carCategory, EngineType engineType) {
        ...
        this.carCategory = requireNonNull(carCategory, "The car category cannot be null");
